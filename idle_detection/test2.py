...
class PersonTracker:
    ...
    def run(self):
        ...
        db_thread.join()
    # def stop(self,isrun):
    #     self.is_running=isrun


def idle_detection_start():
    tracker = PersonTracker(r"C:\Users\MSI20\Desktop\workers\7464110-hd_1080_1920_30fps.mp4")
    tracker.run()
    # return tracker

# def idle_detection_stop(tracker):
#     time.sleep(5)
#     tracker.stop(False) 
