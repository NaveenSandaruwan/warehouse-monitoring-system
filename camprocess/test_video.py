...
def process_video(input_video_path, output_video_path, log_file_path, camcoordinates, rawcoordinates, shared_data, cam_id, use_camera=False):
    ...
    if use_camera:
        ...
        cap = cv2.VideoCapture(input_video_path)  # Use the video file
